...
SUBJECT_TYPE_SCHEMAS = {
    "Person": {
        ...
        "fields": [
            ...
            {"key": "date_of_birth", "label": "Date of Birth", "kind": "date", "placeholder": "YYYY-MM-DD or approximate"},
    ...
    "Domain / Website": {
        ...
        "fields": [
            ...
            {"key": "registration_date", "label": "Registration Date", "kind": "date", "placeholder": "YYYY-MM-DD"},
